...
log = get_logger("timeout_resource.test_cpu_exhaustion")
...
def main() -> int:
    ...
    test_name = "timeout_resource.test_cpu_exhaustion.python"
    ...
    results = mc.export()
    out_path = write_results_json("timeout_resource_test_cpu_exhaustion.json", results)
