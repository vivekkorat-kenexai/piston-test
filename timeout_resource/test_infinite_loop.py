...
log = get_logger("timeout_resource.test_infinite_loop")
...
def main() -> int:
    ...
    code = "while True:\n    pass\n"
    test_name = "timeout_resource.test_infinite_loop.python"
    ...
    try:
        ...
        ok = (elapsed <= kill_window) and (exit_code != 0 or "time" in (stderr + stdout).lower())
        details = {
            "elapsed_s": elapsed,
    ...
    results = mc.export()
    out_path = write_results_json("timeout_resource_test_infinite_loop.json", results)
