...
log = get_logger("timeout_resource.test_thread_explosion")
...
def main() -> int:
    ...
    test_name = "timeout_resource.test_thread_explosion.python"
    ...
    results = mc.export()
    out_path = write_results_json("timeout_resource_test_thread_explosion.json", results)
